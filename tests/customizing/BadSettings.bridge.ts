...
export class BadSettingsPolicyDataBridge extends ContractDataBridge {
    ...
    reader = new BadSettingsPolicyDataBridgeReader(this, this.isMainnet);
...
export class BadSettingsPolicyDataBridgeReader extends DataBridgeReaderClass {
    constructor(public bridge: BadSettingsPolicyDataBridge, isMainnet: boolean) {
        super();
    }
...
export class DelegateActivityHelper extends EnumBridge<isActivity> {
    ...
    get CapoLifecycleActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "BadSettingsPolicy::DelegateActivity.CapoLifecycleActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get DelegateLifecycleActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "BadSettingsPolicy::DelegateActivity.DelegateLifecycleActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get SpendingActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "BadSettingsPolicy::DelegateActivity.SpendingActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get MintingActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "BadSettingsPolicy::DelegateActivity.MintingActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get BurningActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "BadSettingsPolicy::DelegateActivity.BurningActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    * This activity  uses the pattern of spending a utxo to provide a uniqueness seed.
    ...
    /**
     * generates isActivity/redeemer wrapper with UplcData for ***"BadSettingsPolicy::DelegateActivity.OtherActivities"***
     */
    OtherActivities(
        activity: UplcData
    ) : isActivity {
        ...
        }, "BadSettingsPolicy::DelegateActivity.OtherActivities"); /*singleField enum variant*/
       return uplc;
    }
}/*mkEnumHelperClass*/
...
export const DelegateActivitySchema : EnumTypeSchema = {
    ...
    "variantTypes": [
        ...
        },
        {
            "kind": "variant",
            "tag": 9,
            "id": "__module__BadSettingsPolicy__DelegateActivity[]__OtherActivities",
