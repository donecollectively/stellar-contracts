...
export { P as ContractDataBridgeWithEnumDatum, Q as ContractDataBridgeWithOtherDatum, O as DataBridge, M as SeedActivity, J as abbrevAddress, K as abbreviatedDetail, L as abbreviatedDetailBytes, y as addrAsString, k as assetsAsString, I as betterJsonSerializer, z as byteArrayAsString, F as byteArrayListAsString, h as colors, G as datumSummary, f as debugMath, j as displayTokenName, N as getSeed, H as hexToPrintableString, x as lovelaceToAda, p as policyIdAsString, r as realDiv, g as realMul, s as stringToPrintableString, t as toFixedReal, l as txAsString, w as txInputAsString, q as txOutputAsString, E as txOutputIdAsString, B as txidAsString, n as utxoAsString, o as utxosAsString, v as valueAsString } from './DataBridge.mjs';
import { decodeUtf8, encodeUtf8, bytesToHex, equalsBytes } from '@helios-lang/codec-utils';
...
import { E as EnumBridge, C as CapoDataBridge } from './CachedUtxoIndex.mjs';
export { b as CachedUtxoIndex, J as JustAnEnum, N as Nested, a as NotNested, d as debugBox, i as isDatum } from './CachedUtxoIndex.mjs';
...
It's recommended to import your bundle asyncrhonously.Your static scriptBundleClass() method can \`module= await import("./MyAppCapoBundle.js"); return module.MyAppCapoBundle;\`
...
`
  ...
  async mkScriptBundle(setupDetails = placeholderSetupDetails) {
    const c = await this.constructor.scriptBundleClass();
    return c.create({
      params: this.configIn,
      ...setupDetails,
      setup: this.setup
