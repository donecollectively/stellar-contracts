...
import type {
    ...
    ReqtData, ErgoReqtData, ReqtDataLike,
...
import type * as types from "./Reqts.concrete.typeInfo.js";
...
export class ReqtsPolicyDataBridge extends ContractDataBridge {
    ...
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺReqtDataCast = makeCast<ReqtData, ReqtDataLike>(
        ReqtDataSchema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
    /**
 ...
 * @public
 */
export class ReqtsPolicyDataBridgeReader extends DataBridgeReaderClass {
    constructor(public bridge: ReqtsPolicyDataBridge, isMainnet: boolean) {
        super();
    }
datum = (d: UplcData) => { return this.DelegateDatum(d) }
    ...
    ReqtData(d: UplcData) {
        ...
        return cast.fromUplcData(d) as ErgoReqtData;
    } /* structReader helper */
 ...
 * @public
 */
export class ReqtDataHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<ReqtData, ReqtDataLike>(
        ReqtDataSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
...
export class DelegateDatumHelper extends EnumBridge<JustAnEnum> {
    ...
    tn: /*minStructField*/ number[]
        ...
        const uplc = this.mkUplcData({ 
           IsDelegation: dd
        }, "ReqtsData::DelegateDatum.IsDelegation"); /*singleField enum variant*/
        return makeInlineTxOutputDatum(uplc);
    }
...
export class SpendingActivityHelper extends EnumBridge<JustAnEnum> {
    ...
    UpdatingRecord(
        ...
        const uplc = this.mkUplcData({ 
           UpdatingRecord: id
        }, "ReqtsData::SpendingActivity.UpdatingRecord"); /*singleField enum variant*/
       return uplc;
    }
}/*mkEnumHelperClass*/
...
export class BurningActivityHelper extends EnumBridge<JustAnEnum> {
    ...
    DeletingRecord(
        ...
        const uplc = this.mkUplcData({ 
           DeletingRecord: id
        }, "ReqtsData::BurningActivity.DeletingRecord"); /*singleField enum variant*/
       return uplc;
    }
}/*mkEnumHelperClass*/
...
export class DelegateActivityHelper extends EnumBridge<isActivity> {
    ...
    get CapoLifecycleActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "ReqtsPolicy::DelegateActivity.CapoLifecycleActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get DelegateLifecycleActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "ReqtsPolicy::DelegateActivity.DelegateLifecycleActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get SpendingActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "ReqtsPolicy::DelegateActivity.SpendingActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get MintingActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "ReqtsPolicy::DelegateActivity.MintingActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get BurningActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "ReqtsPolicy::DelegateActivity.BurningActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
...
export const ReqtDataSchema : StructTypeSchema = {
    "kind": "struct",
    "format": "map",
