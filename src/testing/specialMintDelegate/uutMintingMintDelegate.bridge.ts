...
export class uutMintingDelegateDataBridge extends ContractDataBridge {
    ...
    /**
                * uses unicode U+1c7a - sorts to the end */
    ᱺᱺSampleStructCast = makeCast<SampleStruct, SampleStructLike>(
        SampleStructSchema,
        { isMainnet: true, unwrapSingleFieldEnumVariants: true }
    );
    /**
...
datum = (d: UplcData) => { return this.DelegateDatum(d) }
    ...
    /**
        ...
        * for the BasicDelegate script.  You may choose to recast this data to
        * SampleStruct or SampleStructLike
        * #### Standard WARNING
        *
        * This is a low-level data-reader for use in ***advanced development scenarios***.
        *
...
export class MintingActivityHelper extends EnumBridge<JustAnEnum> {
     ...
     * See the `tcxWithSeedUtxo()` method in your contract's off-chain StellarContracts subclass 
     * to create a context satisfying `hasSeed`.
     * See `$seeded$mintingUuts}` for use in a context
     * providing an implicit seed utxo. 
     */
    ...
    /**
     * generates  UplcData for ***"uutMintingDelegate::MintingActivity.mintingUuts"***, 
     * @param fields - \{ purposes: Array\<string\> \}
     * @remarks
    * ##### Seeded activity
    * This activity  uses the pattern of spending a utxo to provide a uniqueness seed.
     * ##### Activity contains implied seed
...
export class DelegateActivityHelper extends EnumBridge<isActivity> {
    ...
    * This activity  uses the pattern of spending a utxo to provide a uniqueness seed.
    ...
    /**
     * generates isActivity/redeemer wrapper with UplcData for ***"uutMintingDelegate::DelegateActivity.OtherActivities"***
     */
    OtherActivities(
        activity: UplcData
    ) : isActivity {
        ...
        }, "uutMintingDelegate::DelegateActivity.OtherActivities"); /*singleField enum variant*/
       return uplc;
    }
}/*mkEnumHelperClass*/
...
export const DelegateActivitySchema : EnumTypeSchema = {
    ...
    "variantTypes": [
        ...
        },
        {
            "kind": "variant",
            "tag": 9,
            "id": "__module__uutMintingDelegate__DelegateActivity[]__OtherActivities",
