 ...
 * @public
 */
export class UnspecializedDelegateBridgeReader extends DataBridgeReaderClass {
    constructor(public bridge: UnspecializedDelegateBridge, isMainnet: boolean) {
        super();
    }
...
export class MintingActivityHelper extends EnumBridge<JustAnEnum> {
    ...
    *
     */
    _placeholder1MA(thingWithSeed: hasSeed | TxOutputId | string) 
    : UplcData {
    ...
    * This activity  uses the pattern of spending a utxo to provide a uniqueness seed.
    ...
    get $seeded$_placeholder1MA() {
        return impliedSeedActivityMaker(this,this._placeholder1MA)() // called with no args needed
...
export class DelegateActivityHelper extends EnumBridge<isActivity> {
    ...
    get CapoLifecycleActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "UnspecializedDelegate::DelegateActivity.CapoLifecycleActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get DelegateLifecycleActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "UnspecializedDelegate::DelegateActivity.DelegateLifecycleActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get SpendingActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "UnspecializedDelegate::DelegateActivity.SpendingActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get MintingActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "UnspecializedDelegate::DelegateActivity.MintingActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    get BurningActivities() {
        ...
        nestedAccessor.mkDataVia(
            ...
            "UnspecializedDelegate::DelegateActivity.BurningActivities" + variantSuffix);
        });
        return nestedAccessor;
    } /* nested enum accessor */
    ...
    * This activity  uses the pattern of spending a utxo to provide a uniqueness seed.
    ...
    OtherActivities(
        ...
        }, "UnspecializedDelegate::DelegateActivity.OtherActivities"); /*singleField enum variant*/
       return uplc;
    }
