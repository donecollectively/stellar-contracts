...
`, 
            ` [${this.constructor.name}:specializedDelegateModule()]\n       = ${moduleName}     (generated by stellar-contracts:src/delegation/ContractBasedDelegate.ts: ^^^ mkDelegateWrapper())`, 
            "stellar-contracts"
        );
    }
    ...
    importModules(): HeliosModuleSrc[] {
        ...
        const specializedDelegate = this.specializedDelegateModule;
        ...
        const delegateWrapper = this.mkDelegateWrapper(specializedDelegate.moduleName);
